...
const errorMessages: Record<string, { title: string; description: string; tips: string[] }> = {
  ...
  PDF_LOAD_FAILED: {
    ...
    tips: [
      'Coba buka di Adobe Reader dan save as PDF 1.4',
      'Gunakan Ghostscript untuk normalize PDF structure',
      'Print ke PDF dari aplikasi viewer untuk membuat file baru'
    ]
  },
  TOO_MANY_PAGES: {
